...
check_contains "Greeter uses lifeos-lock.png" "/var/lib/cosmic-greeter/.config/cosmic/com.system76.CosmicBackground/v1/all" "lifeos-lock"
...
check "Desktop wallpaper" "/usr/share/backgrounds/lifeos/lifeos-axi-night.png"
check "Lock screen wallpaper" "/usr/share/backgrounds/lifeos/lifeos-lock.png"

...
check_contains "Greeter uses lifeos-lock.png" "/var/lib/cosmic-greeter/.config/cosmic/com.system76.CosmicBackground/v1/all" "lifeos-lock.png"
check "Greeter wallpaper sync script" "/usr/local/bin/lifeos-sync-greeter-wallpaper.sh"
check "Greeter branding service" "/usr/lib/systemd/system/lifeos-cosmic-greeter-branding.service"
check "Greeter wallpaper state" "/var/lib/cosmic-greeter/.local/state/cosmic/com.system76.CosmicBackground/v1/wallpapers"
check_contains "Greeter wallpaper state references lifeos-lock.png" "/var/lib/cosmic-greeter/.local/state/cosmic/com.system76.CosmicBackground/v1/wallpapers" "lifeos-lock.png"
...
check "Desktop wallpaper PNG" "/usr/share/backgrounds/lifeos/lifeos-default.png"
check "Desktop wallpaper SVG source" "/usr/share/backgrounds/lifeos/lifeos-default.svg"
check "Lock screen wallpaper PNG" "/usr/share/backgrounds/lifeos/lifeos-lock.png"
check "Lock screen wallpaper SVG source" "/usr/share/backgrounds/lifeos/lifeos-lock.svg"
...
check_contains "Skeleton wallpaper uses lifeos-default.png" "/etc/skel/.config/cosmic/com.system76.CosmicBackground/v1/all" "lifeos-default.png"
check "Skeleton icon theme" "/etc/skel/.config/cosmic/com.system76.CosmicTk/v1/icon_theme"
check "Skeleton interface font" "/etc/skel/.config/cosmic/com.system76.CosmicTk/v1/interface_font"
check "Skeleton monospace font" "/etc/skel/.config/cosmic/com.system76.CosmicTk/v1/monospace_font"

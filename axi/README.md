...
| 📊 **Dashboard** | FastAPI + Alpine.js · event log · brain metrics · daily digest · meeting search · chat con Axi · PWA instalable |
...
3. Desde el celular, abrí `http://<ip-vpn>:8081`. Chrome ofrece "Instalar app" (PWA).

...
def _graph_relation_lines(matched_ids: set, conn, *, max_rel: int = 8) -> list[str]:
    ...
    'hipertensión diagnosticada por Dra. Tere', so who/what/where questions can
...
def _build_recall_block(
    ...
    *,
    ...
    # graph relations (e.g. hipertensión --diagnosticada_por--> Dra. Tere) so a
    ...
    # typed edges (hipertensión diagnosticada por Dra. Tere; tratada con losartán).

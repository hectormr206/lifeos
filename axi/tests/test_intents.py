...
CASES = [
    ...
    # ── English command palette (bilingual union grammar) ──
    ("axi, open the dashboard", "open_dashboard"),
    ("axi open dashboard", "open_dashboard"),
    ("axi, start the meeting", "meeting_start"),
    ("axi begin the meeting", "meeting_start"),
    ("axi, stop the meeting", "meeting_stop"),
    ("axi end the meeting", "meeting_stop"),
    ("axi, clear the conversation", "clear_conversation"),
    ("axi forget the conversation", "clear_conversation"),
    ("axi, turn on the interpreter", "translate_on"),
    ("axi turn off the interpreter", "translate_off"),
    ("axi, game mode on", "game_on"),
    ("axi, game mode off", "game_off"),
